              ...
              <div
                @click="
                  Base.downloadFromUrl(
                    `${environment.IMAGE_API}/Excel/Template/employee.xlsx`
                  )
                "
    ...
    <div class="table-function sticky">
      <div class="form-fix">
        ...
        <base-form-key-search
          ...
          :moduleFilter="ModuleName.Employee"
        ></base-form-key-search>
      </div>
      <div style="min-width: 350px" class="table-function_search">
        <div class="search-table">
          <input
            ...
            type="text"
            :placeholder="$t('module.cash.search_employee_code_name')"
          />
...
function loadDropDown() {
  Base.apiService.callApi(
    new BranchApi().getDropdown,
    null,
    async (response: any) => {
      optionBranch.value = response;
    }
  );
}
