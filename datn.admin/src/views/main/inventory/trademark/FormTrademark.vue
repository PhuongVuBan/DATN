    ...
    <div class="form form_trademark_in">
      ...
      <div class="form-container">
        ...
        <div class="form-item_input">
          ...
          <div class="form-group ms-small">
            <base-input
              ...
              :messageValid="
                t('validate.empty', {
                  field: t('module.inventory.trademarkCode'),
                })
              "
              :label="$t('common.id')"
          ...
          <div class="form-group ms-big">
            <base-input
              ...
              :messageValid="
                t('validate.empty', {
                  field: t('module.inventory.trademarkName'),
                })
              "
              :label="$t('common.name')"
        ...
        <div class="form-group">
          ...
          <textarea class="input" v-model="trademark.description"></textarea>
        </div>
        <div class="form-group ms-big">
  ...
  try {
    ...
    if (messValid.length > 0) {
      ...
      props.Base.showNotificationError(messValid, () => {
        props.Base.focusInputError("form_trademark_in"), listenEvent();
      });
    } else {
      if (
...
function validateInput() {
  return [
    /** Validate code */
    trademark.value.trademarkCode.trim() === ""
      ? t("validate.empty", { field: t("module.inventory.trademarkCode") })
      : null,
    /** Validate name */
    trademark.value.trademarkName.trim() === ""
      ? t("validate.empty", { field: t("module.inventory.trademarkName") })
      : null,
  ].filter((item) => {
    if (item) {
      return true;
...
const handleCloseModal = () => {
  try {
    if (
      JSON.stringify(trademark.value) !=
      JSON.stringify(trademarkComparison.value)
    ) {
      unListenEvent();
