  ...
  <div class="container-table">
              ...
              <div
                @click="
                  Base.downloadFromUrl(
                    `${environment.IMAGE_API}/Excel/Template/depot.xlsx`
                  )
                "
      ...
      <div class="form-fix">
        <div class="search-table">
          <input
            ...
            type="text"
            :placeholder="$t('module.inventory.search_depot_code_name')"
          />
          <div class="icon-search"></div>
        </div>
        <base-form-key-search
          :loadData="Base.loadData"
          :moduleFilter="ModuleName.Depot"
        ></base-form-key-search>
      </div>
    ...
    <teleport to="#app">
      <base-modal-form v-if="Base.isShowModal">
        <form-depot :Base="Base"> </form-depot>
      </base-modal-form>
...
const FormDepot = defineAsyncComponent(() => import("./FormDepot.vue"));
