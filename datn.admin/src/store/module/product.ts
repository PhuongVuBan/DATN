...
import { product } from './column-module/index'
 ...
 * HAN - 08.03.2023
 */
const products: BaseStore = new BaseStore(ModuleName.Product, product, mutations, actions, actionTable);
