...
let columns: Header [] = [
  ...
  new Header(
    ...
    "250",
    { typeSearch: TypeSearch.Text, columnSearch: "product.size" , typeFilter: TypeFilter.Text, module: ModuleName.Product, headerSearch: 'module.inventory.size',},
  ),
  new Header(
    "depotCode",
    "depot.DepotCode",
  ...
  new Header(
    ...
    "200",
    { typeSearch: TypeSearch.Text, columnSearch: "product.Quantity" , typeFilter: TypeFilter.Text, module: ModuleName.Product, headerSearch: 'module.inventory.quantity'},
  ),
  new Header(
    "isActive",
    "product.IsActive",
