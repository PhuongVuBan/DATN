...
const FormOrigin = defineAsyncComponent(
  () => import("../origin/FormOrigin.vue")
);
const FormTrademark = defineAsyncComponent(
  () => import("../trademark/FormTrademark.vue")
);
const FormCategory = defineAsyncComponent(
  () => import("../category/FormCategory.vue")
);
const { t } = useI18n();
