  ...
  <div class="container-table">
    ...
    <div class="table-function sticky">
      <div class="form-fix">
        ...
        <base-form-key-search
          ...
          :moduleFilter="ModuleName.Trademark"
        ></base-form-key-search>
      </div>
    ...
    <teleport to="#app">
      <base-modal-form v-if="Base.isShowModal">
        <form-trademark :Base="Base"> </form-trademark>
      </base-modal-form>
      <base-setting
...
const FormTrademark = defineAsyncComponent(() => import("./FormTrademark.vue"));
 ...
 * HAN 13-03-2023
 */
const api: TrademarkApi = new TrademarkApi();

/** Sử dụng base thư viện Grid đã viết */
const Base: Grid = reactive(new Grid(ModuleName.Trademark, api));
