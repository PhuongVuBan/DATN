  ...
  <div class="container-table">
    ...
    <div class="table-function sticky">
      <div class="form-fix">
        ...
        <base-form-key-search
          ...
          :moduleFilter="ModuleName.Category"
        ></base-form-key-search>
      </div>
    ...
    <teleport to="#app">
      <base-modal-form v-if="Base.isShowModal">
        <form-category :Base="Base"> </form-category>
      </base-modal-form>
      <base-setting
...
const FormCategory = defineAsyncComponent(() => import("./FormCategory.vue"));
 ...
 * HAN 13-03-2023
 */
const api: CategoryApi = new CategoryApi();

/** Sử dụng base thư viện Grid đã viết */
const Base: Grid = reactive(new Grid(ModuleName.Category, api));
