    ...
    <div class="form form_depot_in">
          ...
          <h2>
            {{
              Base.StateForm === ActionTable.Add
                ? $t("common.add_record", {
                    module: $t(`module.inventory.${ModuleName.Depot}_small`),
                  })
      ...
      <div class="form-container">
        <div class="form-item_input">
          ...
          <div class="form-group ms-small">
            <base-input
              ...
              :maxLength="20"
              :messageValid="
                t('validate.empty', { field: t('module.inventory.depotCode') })
              "
              :label="$t('common.id')"
          ...
          <div class="form-group ms-big">
            <base-input
              ...
              :maxLength="255"
              :messageValid="
                t('validate.empty', { field: t('module.inventory.depotName') })
              "
              :label="$t('common.name')"
        ...
        <div class="form-group">
          ...
          <textarea class="input" v-model="depot.depotDelivery"></textarea>
        </div>
      </div>
  ...
  try {
    ...
    if (messValid.length > 0) {
      ...
      props.Base.showNotificationError(messValid, () => {
        props.Base.focusInputError("form_depot_in"), listenEvent();
      });
    } else {
      if (
...
function validateInput() {
  return [
    /** Validate code */
    depot.value.depotCode.trim() === ""
      ? t("validate.empty", { field: t("module.inventory.depotCode") })
      : null,
    /** Validate name */
    depot.value.depotName.trim() === ""
      ? t("validate.empty", { field: t("module.inventory.depotName") })
      : null,
  ].filter((item) => {
    if (item) {
